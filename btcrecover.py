...
if __name__ == "__main__":
    ...
    if isinstance(password_found, str):
        ...
        print()
        print(
            "You may also consider donating to Gurnec, who created and maintained this tool until "
            "late 2017 @ 3Au8ZodNHPei7MQiSVAWb7NB2yqsb48GW4")
        print()
