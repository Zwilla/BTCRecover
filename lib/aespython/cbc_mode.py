...
Algorithm per NIST SP 800-38A https://csrc.nist.gov/publications/nistpubs/800-38a/sp800-38a.pdf
...
class CBCMode(Mode):
    ...
    def encrypt_block(self, plaintext):
        ...
        a0 = self._iv = self._block_cipher.cipher_block((a0 ^ b0, a1 ^ b1, a2 ^ b2, a3 ^ b3, a4 ^ b4, a5 ^ b5, a6 ^ b6,
                                                         a7 ^ b7, a8 ^ b8, a9 ^ b9, aa ^ ba, ab ^ bb, ac ^ bc, ad ^ bd,
                                                         ae ^ be, af ^ bf))
        return a0
