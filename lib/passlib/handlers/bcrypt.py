...
* support 2x and altered-2a hashes?
  https://www.openwall.com/lists/oss-security/2011/06/27/9
...
from lib.passlib.utils.compat import u, uascii_to_str, unicode, str_to_uascii, PY3, error_from
...
class _BcryptCommon(uh.SubclassBackendMixin, uh.TruncateMixin, uh.HasManyIdents,
    ...
    def _finalize_backend_mixin(mixin_cls, backend, dryrun):
        ...
        def assert_lacks_8bit_bug(ident):
            ...
            test cases from <https://cvsweb.openwall.com/cgi/cvsweb.cgi/Owl/packages/glibc/crypt_blowfish/wrapper.c.diff?r1=1.9;r2=1.10>
        ...
        def detect_wrap_bug(ident):
            ...
            test cases from <https://www.openwall.com/lists/oss-security/2012/01/02/4>
