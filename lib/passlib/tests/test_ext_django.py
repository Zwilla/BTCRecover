...
from lib.passlib.ext.django.utils import (
    DJANGO_VERSION, MIN_DJANGO_VERSION, DjangoTranslator, quirks,
)
from lib.passlib.utils.compat import iteritems, get_method_function, u
from lib.passlib.utils.decor import memoized_property
# tests
from lib.passlib.tests.utils import TestCase, TEST_MODE, handler_derived_from
...
#----------------------------------------------------
from lib.passlib.hash import django_pbkdf2_sha256
sample_hashes = dict(
...
class DjangoExtensionTest(_ExtensionTest):
    ...
    def test_13_config_defaults(self):
        ...
        from lib.passlib.ext.django.utils import PASSLIB_DEFAULT
