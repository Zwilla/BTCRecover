...
from lib.passlib.utils import repeat_string, to_bytes, is_safe_crypt_input
from lib.passlib.utils.compat import irange, PY3
from lib.passlib.tests.utils import HandlerCase, TEST_MODE
from lib.passlib.tests.test_handlers import UPASS_TABLE
# module
...
class _bcrypt_test(HandlerCase):
    ...
    known_correct_hashes = [
        ...
        #
        # test vectors from https://www.openwall.com/crypt v1.2
    ...
    def crypt_supports_variant(self, hash):
        ...
        from lib.passlib.handlers.bcrypt import bcrypt, IDENT_2X, IDENT_2Y
        from lib.passlib.utils import safe_crypt
    ...
    def fuzz_verifier_pybcrypt(self):
        ...
        from lib.passlib.handlers.bcrypt import (
        ...
        from lib.passlib.handlers.bcrypt import _pybcrypt as bcrypt_mod
...
class _bcrypt_sha256_test(HandlerCase):
    ...
    def test_calc_digest_v2(self):
        ...
        """
        from lib.passlib.hash import bcrypt
        from lib.passlib.crypto.digest import compile_hmac
        from lib.passlib.utils.binary import b64encode
