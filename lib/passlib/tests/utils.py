...
from lib.passlib.tests.backports import TestCase as _TestCase, skip, skipIf, skipUnless, SkipTest
...
from lib.passlib.utils.compat import iteritems, irange, u, unicode, PY2, nullcontext
...
class HandlerCase(TestCase):
    ...
    def setUp(self):
        ...
        from lib.passlib.utils import handlers
    ...
    * check that native crypt support is detected correctly for known platforms.
    ...
    def test_81_crypt_fallback(self):
        ...
        if self.has_os_crypt_fallback:
            ...
            from lib.passlib.exc import InternalBackendError as err_type
            hash = self.get_sample_hash()[1]
    ...
    def fuzz_verifier_crypt(self):
        ...
        from lib.passlib.utils import _safe_crypt_lock
