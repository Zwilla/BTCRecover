...
if JYTHON: # pragma: no cover -- runtime detection
    ...
    # see https://bugs.jython.org/issue1758320
    try:
        import stringprep
    except ImportError:
        stringprep = None
...
def consteq(left, right):
    ...
    #       https://bugs.python.org/issue15061
    #       https://bugs.python.org/issue14955
...
def saslprep(source, param="value"):
    ...
    .. note::
        ...
        (`Jython issue 1758320 <https://bugs.jython.org/issue1758320>`_).

    .. versionadded:: 1.6
    """
    # saslprep - https://tools.ietf.org/html/rfc4013
    # stringprep - https://tools.ietf.org/html/rfc3454
    #              https://docs.python.org/library/stringprep.html
