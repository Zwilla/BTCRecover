...
def scrypt_test(scrypt_opencl_algos, passwords, N_value=15, r_value=3, p_value=1, desired_key_length=32,
    ...
    for pwd in passwords:
        v = pyscrypt.hash(pwd, hex_salt, 1 << N_value, 1 << r_value, 1 << p_value, desired_key_length)
...
def main(argv):
    ...
    # passwordlist = []
    # passwordlist.append(b'style bless bonus turkey century moon country check suit mesh remember enjoy strong
    # broom cliff chunk arrow nerve choose broken history ritual need shop')
    # for i in range(1023):
    #        passwordlist.append(b"style bless bonus turkey century moon country check suit mesh remember
    #        enjoy strong broom cliff chunk arrow nerve choose broken history ritual need "
    #                     + str(i).encode())

    # passwordlist = [b'password', b'hmm', b'trolololl', b'madness']
    passwordlist = [b'btcr-test-password:\x02', b'btcr-test-password:p2pkh\x02', b'btcr-test-password:p2wpkh-p2sh\x02',
                    b'btcr-test-password:p2wpkh-p2shp2pkh\x02', b'btcr-test-password:p2pkhp2wpkh-p2sh\x02',
                    b'btcr-test-password:p2wpkh\x02', b'btcr-test-password:p2wpkhp2pkh\x02',
                    b'btcr-test-password:p2pkhp2wpkh\x02']
    import itertools
    # salts = []
    # for i in range(1024):
